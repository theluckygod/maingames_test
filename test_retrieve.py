...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', default='test_data/test_images', type=str, help='images path')
    parser.add_argument('--ground_truth_path', default='test_data/test.txt', type=str, help='ground truth path')
    ...
    testset = HeroTestDataset(trainset.get_class_dict(),
